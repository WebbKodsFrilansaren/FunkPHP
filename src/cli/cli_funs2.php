...
function cli_restore_default_folders_and_files()
{
    ...
    $folders = [
        ...
        "$folderBase/funkphp/_internals/batteries/pipeline/request/",
        "$folderBase/funkphp/_internals/batteries/pipeline/post-request/",
        ...
        "$folderBase/funkphp/test/",
        "$folderBase/funkphp/template/",
        "$folderBase/funkphp/schema/",
