...
$requiredWritablePaths = [
    ...
    'Batteries Pipeline Main Directory'    => __DIR__ . '/../batteries/pipes',
    'Batteries Middlewares Directory'    => __DIR__ . '/../batteries/pipes/middlewares',
    'Batteries Pipeline Post-Response Directory'    => __DIR__ . '/../batteries/pipes/post_response',
    'Batteries Pipeline Request Directory'    => __DIR__ . '/../batteries/pipes/request',
    ...
    'FunkPHP Configuration Directory'    => __DIR__ . '/../funkphp/config',
    'FunkPHP Middlewares Directory'    => __DIR__ . '/../funkphp/pipes/middlewares',
    ...
    'FunkPHP Pipeline Main Directory'    => __DIR__ . '/../funkphp/pipes',
    'FunkPHP Pipeline Post-Response Directory'    => __DIR__ . '/../funkphp/pipes/post_response',
    'FunkPHP Pipeline Request Directory'    => __DIR__ . '/../funkphp/pipes/request',
    'FunkPHP Routes Directory'    => __DIR__ . '/../funkphp/pipes/routes',
    'FunkPHP Data Main Directory'    => __DIR__ . '/../funkphp/data',
    'FunkPHP Data Compiled Directory'    => __DIR__ . '/../funkphp/data/compiled',
    'FunkPHP Data Query Directory'    => __DIR__ . '/../funkphp/data/query',
    'FunkPHP Data SQL Directory'    => __DIR__ . '/../funkphp/data/sql',
    'FunkPHP Data Validation Directory'    => __DIR__ . '/../funkphp/data/validation',
...
foreach ($requiredWritablePaths as $name => $path) {
    ...
    if (!is_readable($realPath)) {
        $compatibilityErrors[] = "<strong>{$name}:</strong> The folder at '<code>{$realPath}</code>' is NOT READABLE by the Web Server. File Permission issues?";
    }
    if (!is_writable($realPath)) {
        $compatibilityErrors[] = "<strong>{$name}:</strong> The folder at '<code>{$realPath}</code>' is NOT WRITABLE by the Web Server.  File Permission issues?";
    }
}
# =========================================================================
...
$currentUser = extension_loaded('posix') ? (posix_getpwuid(posix_geteuid())['name'] ?? 'Unknown User') : 'Unknown User';
